...
public class DrawCommand implements Serializable {
    ...
    // void arc(double x, double y, double radius, double startAngle, double
    // endAngle)
    // void arc(double x, double y, double radius, double startAngle, double
    ...
    // double y1)
    // CanvasPattern createPattern(CanvasElement image, Context2d.Repetition
    // repetition)
    // CanvasPattern createPattern(CanvasElement image, java.lang.String
    // repetition)
    // CanvasPattern createPattern(ImageElement image, Context2d.Repetition
    // repetition)
    // CanvasPattern createPattern(ImageElement image, java.lang.String
    // repetition)
    ...
    // void drawImage(CanvasElement image, double dx, double dy, double dw,
    // double dh)
    // void drawImage(CanvasElement image, double sx, double sy, double sw,
    // double sh, double dx, double dy, double dw, double dh)
    // void drawImage(ImageElement image, double dx, double dy)
    // void drawImage(ImageElement image, double dx, double dy, double dw,
    // double dh)
    // void drawImage(ImageElement image, double sx, double sy, double sw,
    // double sh, double dx, double dy, double dw, double dh)
    // void fill()
    ...
    // void setGlobalCompositeOperation(java.lang.String
    ...
    // void setTransform(double m11, double m12, double m21, double m22, double
    // dx, double dy)
    // void stroke()
